            ...
            <div className='flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4'>
                <div className='flex flex-1 justify-start flex-col mf:mr-10'>
                    ...
                    <button
                        ...
                        className='flex flex-row justify-center items-center my-5 bg-[#2952e3] p-3 rounded-full cursor-pointer hover:bg-[#2f46bd]'
                    >
                        <p className='text-white text-base font-semibold'>Connect Wallet</p>
                    </button>
                    {/* Grid to all images */}
                    <div className='grid sm:grid-cols-3 grid-cols-2 w-full m-10'>
                ...
                <div className='flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10'>
                    <div className='p-3 justify-end items-start flex-col rounded-xl h-40 small:w-72 w-full my-5 eth-card white-glassmorphism'>
